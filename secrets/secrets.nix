let
  ...
  nixos-macbookair-zifan = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIIMPRbG0ogui/sRecGgAjOvd5bLFqyX/rSh7I/vbOCYs zifan@nixos";
  users = [
  ...
  nixos-macbookair-system = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIJcb0+jSQ8yeKKq8xdwkf+nJ58g4IDZbSCPeF9MlqvVe root@nixos";
  systems = [
