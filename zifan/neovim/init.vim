...
set expandtab
" set one tab means 4 spaces
set tabstop=4
" expand one tab to 4 spaces
set shiftwidth=4
" let vim to see 4 spaces as a tab
set softtabstop=4
...
" indent
" use Shift> to indent in visual mode
" Shift< to unindent in visual mode

" terminal mode
" exit terminal mode
tnoremap <Esc> <C-\><C-n>

let g:explorer_open = 0

function! s:toggle_explorer()
    if (!g:explorer_open)
        execute 'CocCommand explorer'
        let g:explorer_open = 1
    endif
endfunction

augroup ToggleExplorer
  autocmd!
